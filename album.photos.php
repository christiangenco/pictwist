...
<a class="returnLink" href="<?php echo $profileURL;?>"<?php if($uid != $currentUser['id']){echo "?u_id=".$prof_id;}?>>&lt; Back to <?php if($uid == $currentUser['id']){echo " My ";} else{echo " the ";}?> Profile</a>
    <?php
